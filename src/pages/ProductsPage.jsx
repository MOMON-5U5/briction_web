      ...
      <div className="container mx-auto px-4">
        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <img  alt="Produk kustom BRICTION" className="rounded-lg shadow-xl" src="https://github.com/MOMON-5U5/foto-konten/blob/main/Briction%20Katalog/002.png?raw=true" />
            </div>
          </div>
        </motion.div>
      </div>
